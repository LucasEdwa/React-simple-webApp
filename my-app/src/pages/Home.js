          ...
          <div className='banner m-10'>
            <Slider className='overflow-hidden' {...settings}>
              ...
              {slider.map((slider, index) => (
                ...
                <img className='w-full object-cover h-40 overflow-y-hidden' src={slider.src} alt='banner' />
                  <div className=' p-10'>
           ...
           <div className='flex  bg-red-900 p-8 space-x-40 justify-center text-amber-400'>
           ...
           <section className='p-1 flex justify-center border border-gray-500'>
            ...
            <div className="flex flex-col gap-4 m-16 text-white">
                ...
                {error?             
                <p className="bg-red-600 p-4 w-1/4 rounded-xl">You entered the worng password. Please, try again.</p>
                :null}
